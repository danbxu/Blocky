...
public class TestBlockly {
     ...
     */
    public static void swap_operation(Scanner in, 
            IGame game, IBlock root) {
     ...
     * @param root the root of the tree of blocks
     */
    public static void rotate_operation(Scanner in, 
            IGame game, IBlock root) {
     ...
     * @param root the root of the tree of blocks
     */
    public static void smash_operation(Scanner in, 
            IGame game, IBlock root) {
